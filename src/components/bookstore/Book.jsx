...
import { deleteBookThunk } from "../../redux/book/thunk/deleteBookThunk";
import { edit_book } from "../../redux/book/actions";
...
const Book = ({ book }) => {
  ...
  const handelSelectedBook = () => {
    dispatch(edit_book(book));
  };
  return (
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          <div className="text-gray-500 space-x-2">
            <button className="lws-edit" onClick={handelSelectedBook}>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
        ...
        <div className="space-y-2 mt-4 h-full">
          ...
          <div className="lws-stars">
            {Array.from({ length: rating }, (_, i) => i).map((star, i) => (
              <svg
                key={i}
                viewBox="0 0 20 20"
                fill="currentColor"
